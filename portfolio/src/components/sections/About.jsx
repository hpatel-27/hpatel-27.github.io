        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              ...
              learning how I can use tech to make life better. If I’m not
              working on a project or exploring deep learning architectures, I’m
              probably watching basketball (Go Raptors!), playing Rocket League,
              or lifting at the gym. I’m always looking for fun ways to turn
              ideas into something real and impactful.
            </p>
            ...
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-5">
                ...
                <li>
                  ...
                  Algorithms, Software Engineering, App Web Computing, Operating
                  Systems
                </li>
                <li>
              ...
              <div className="space-y-5 text-gray-300">
                <div>
                  <h4 className="font-semibold">
                    Software Engineering Intern @ iQuadra (May 2024 - August
                    2024)
                  </h4>
                ...
                <div>
                  <h4 className="font-semibold">
                    Undergraduate Researcher @ NCSU (December 2024 - August
                    2024)
                  </h4>
                  <ul className="list-disc list-inside text-gray-400 space-y-2 mt-1">
                    <li>
                      Engineering a 1/16 scale autonomous vehicle system using
                      ROS 2, OpenCV, LiDAR, and a Zed2i camera to perform
                      real-time lane detection and navigation.
                    </li>
                    <li>
                      Utilized Dijkstra’s algorithm for autonomous intersection
                      traversal and implemented manual control using an Xbox
                      controller to validate perception features such as
                      obstacle detection.
                    </li>
                  </ul>
                </div>
